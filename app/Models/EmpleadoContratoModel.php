...
class EmpleadoContratoModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'tipo_contrato','duracion','nivel','fecha_sige','centro_costo',
        'dpto','division','centro_trabajo','tipo_ingreso','periodo_pago',
        'tipo_cuenta','banco','cuenta','porcentaje_arl','primera_vez',
        'usuario_contrato','ultimo_cambio','estado_contrato','cno','nombre_cno',
        'audit_created_by','audit_updated_by','created_at','updated_at',
    ];

    // reglas rápidas para consultas
    public function byEmpleado(int $empleadoId)
    {
