...
class EmpleadoModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'fecha_nacimiento','ciudad_nac','dpto_nac','sexo','estado_civil',
        'grupo_sanguineo','grupo_social','mujer_cf',
        ...
        'correo','telefono','celular','activo'
    ];

    public function findByCedula(string $cedula): ?array
    {
        return $this->where('numero_documento', $cedula)->first();
    }
}
